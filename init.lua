...
vim.keymap.set('n', '<leader>O', ":<C-u>call append(line('.') - 1, repeat([''], v:count1))<CR>", { desc = 'Newline above' })

vim.keymap.set('n', '<leader>M', ':e ++ff=dos<enter> <BAR> :set ff=unix<enter> <BAR> :w<enter>', { desc = 'Switch to unix line endings' })
